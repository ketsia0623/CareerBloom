...
const NewHomePage = ({ navigateTo }: { navigateTo: (page: string) => void }) => {
  ...
  // Custom styles for the cute pink theme
  const styles = {
    container: {
      backgroundColor: "#ffecf1", // Light pink background
      padding: "20px",
      borderRadius: "10px",
      minHeight: "100vh"
    },
    ...
    navbarBrand: {
      fontSize: "1.8rem",
      fontWeight: "bold", 
      color: "#ff66b2", // Darker pink for visibility
      cursor: "pointer"
    },
    navLink: {
      color: "#ff66b2",
    ...
    cardText: {
      color: "#603549" // Dark pink/purple for visibility
    },
    button: {
  ...
  return (
    <Container fluid style={styles.container}>
      ...
      {/* Main Content */}
      <div style={styles.mainContent} className="text-center">
        {/* About Section */}
        <Row className="mb-4">
